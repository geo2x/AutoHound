...
from bloodhound_ai.models import AttackPath
...
class AttackNavigatorGenerator:
    ...
    LAYER_TEMPLATE = {
        "name": "BloodHound AI Attack Paths",
        "versions": {
            "attack": "14",
            "navigator": "4.9",
            "layer": "4.5"
        ...
        "description": "Attack techniques identified by BloodHound AI analysis",
        "filters": {
            "platforms": ["Windows"]
        },
        "sorting": 0,
