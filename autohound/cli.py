...
from autohound.ingestor import JsonIngestor, Neo4jIngestor
from autohound.reasoning import LLMEngine
from autohound.reporting import AttackNavigatorGenerator, MarkdownReportGenerator
...
def main(
    ...
    try:
        ...
        if neo4j_uri:
            ...
            json_ingestor = JsonIngestor(input_path)
            graph = json_ingestor.ingest()
